/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Mon Feb  1 17:23:00 2016 */
...
static char __pyx_k_home_irshad_Projects_GITProject[] = "/home/irshad/Projects/GITProjects/python-irtrans/irtrans/_decode/viterbi.pyx";
...
/* "irtrans/_decode/viterbi.pyx":14
...
static PyMethodDef __pyx_mdef_7irtrans_7viterbi_1decode = {__Pyx_NAMESTR("decode"), (PyCFunction)__pyx_pw_7irtrans_7viterbi_1decode, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
...
static PyObject *__pyx_pf_7irtrans_7viterbi_decode(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_score, PyArrayObject *__pyx_v_b_trans, PyArrayObject *__pyx_v_init, PyArrayObject *__pyx_v_final) {
  ...
  /* "irtrans/_decode/viterbi.pyx":24
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":26
 *     n_samples, n_states = score.shape[0], score.shape[1]
 * 
 *     backp = np.empty((n_samples, n_states), dtype=np.intp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":28
 *     backp = np.empty((n_samples, n_states), dtype=np.intp)
 * 
 *     for j in range(n_states):             # <<<<<<<<<<<<<<
 *         score[0, j] += init[j]
 ...
 */
  ...
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_2; __pyx_t_1+=1) {
    ...
    /* "irtrans/_decode/viterbi.pyx":29
 * 
 *     for j in range(n_states):
 *         score[0, j] += init[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":32
 * 
 *     # Forward recursion. score is reused as the DP table.
 ...
 */
  ...
  for (__pyx_t_1 = 1; __pyx_t_1 < __pyx_t_2; __pyx_t_1+=1) {
    ...
    /* "irtrans/_decode/viterbi.pyx":33
 *     # Forward recursion. score is reused as the DP table.
 *     for i in range(1, n_samples):
 *         for k in range(n_states):             # <<<<<<<<<<<<<<
 *             maxind = 0
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "irtrans/_decode/viterbi.pyx":34
 *     for i in range(1, n_samples):
 *         for k in range(n_states):
 *             maxind = 0             # <<<<<<<<<<<<<<
 *             maxval = NEGINF
 ...
 */
      ...
      /* "irtrans/_decode/viterbi.pyx":35
 *         for k in range(n_states):
 *             maxind = 0
 *             maxval = NEGINF             # <<<<<<<<<<<<<<
 *             for j in range(n_states):
 ...
 */
      ...
      /* "irtrans/_decode/viterbi.pyx":36
 *             maxind = 0
 *             maxval = NEGINF
 *             for j in range(n_states):             # <<<<<<<<<<<<<<
 *                 candidate = score[i - 1, j] + b_trans[j, k] + score[i, k]
 ...
 */
      ...
      for (__pyx_t_19 = 0; __pyx_t_19 < __pyx_t_18; __pyx_t_19+=1) {
        ...
        /* "irtrans/_decode/viterbi.pyx":37
 *             maxval = NEGINF
 *             for j in range(n_states):
 *                 candidate = score[i - 1, j] + b_trans[j, k] + score[i, k]             # <<<<<<<<<<<<<<
 *                 if candidate > maxval:
 ...
 */
        ...
        /* "irtrans/_decode/viterbi.pyx":38
 *             for j in range(n_states):
 *                 candidate = score[i - 1, j] + b_trans[j, k] + score[i, k]
 *                 if candidate > maxval:             # <<<<<<<<<<<<<<
 *                     maxind = j
 ...
 */
        ...
        if (__pyx_t_26) {
          ...
          /* "irtrans/_decode/viterbi.pyx":39
 *                 candidate = score[i - 1, j] + b_trans[j, k] + score[i, k]
 *                 if candidate > maxval:
 *                     maxind = j             # <<<<<<<<<<<<<<
 *                     maxval = candidate
 ...
 */
          ...
          /* "irtrans/_decode/viterbi.pyx":40
 *                 if candidate > maxval:
 *                     maxind = j
 *                     maxval = candidate             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "irtrans/_decode/viterbi.pyx":42
 *                     maxval = candidate
 * 
 *             score[i, k] = maxval             # <<<<<<<<<<<<<<
 *             backp[i, k] = maxind
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_score.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_score.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_score.diminfo[1].strides) = __pyx_v_maxval;
      ...
      /* "irtrans/_decode/viterbi.pyx":43
 * 
 *             score[i, k] = maxval
 *             backp[i, k] = maxind             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":45
 *             backp[i, k] = maxind
 * 
 *     for j in range(n_states):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_2; __pyx_t_1+=1) {
    ...
    /* "irtrans/_decode/viterbi.pyx":46
 * 
 *     for j in range(n_states):
 *         score[n_samples - 1, j] += final[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":49
 * 
 *     # Path backtracking
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":50
 *     # Path backtracking
 *     path = np.empty(n_samples, dtype=np.intp)
 *     path[n_samples - 1] = score[n_samples - 1, :].argmax()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  *__Pyx_BufPtrCContig1d(npy_intp *, __pyx_pybuffernd_path.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_path.diminfo[0].strides) = __pyx_t_2;
  ...
  /* "irtrans/_decode/viterbi.pyx":52
 *     path[n_samples - 1] = score[n_samples - 1, :].argmax()
 * 
 *     for i in range(n_samples - 2, -1, -1):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_2 = (__pyx_v_n_samples - 2); __pyx_t_2 > -1; __pyx_t_2-=1) {
    ...
    /* "irtrans/_decode/viterbi.pyx":53
 * 
 *     for i in range(n_samples - 2, -1, -1):
 *         path[i] = backp[i + 1, path[i + 1]]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "irtrans/_decode/viterbi.pyx":55
 *         path[i] = backp[i + 1, path[i + 1]]
 * 
 *     return path             # <<<<<<<<<<<<<<
 */
